...
int main()
{
    int adm[10],rl[10],marks[10],sub1[10],sub2[10],sub3[10],sub4[10],sub5[10],per[10],total[10];
    int n,i;
    ...
    printf("--------------------------------------------------------------------");
    printf("\n adm\t rl \t sub1 \t sub2 \t sub3 \t sub4 \t sub5 \t Total ");
    printf("\n------------------------------------------------------------------");
    for(i=0;i<n;i++)
    {
        printf("\n%d\t%d\t%3d\t%3d\t%3d\t%3d\t%3d\t%4d",adm[i],rl[i],sub1[i],sub2[i],sub3[i],sub4[i],sub5[i],total[i]);
